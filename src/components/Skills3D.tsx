...
function SkillCube({ position, label, index, image }: { position: [number, number, number], label: string, index: number, image: string }) {
...
function SkillsScene() {
  ...
  return (
    <>
      ...
      <pointLight position={[-10, -10, -5]} color="#feffffff" intensity={2} />
...
export default function Skills3D() {
  ...
  const skillCategories = [
    ...
    {
      title: 'Cloud & Devops',
      skills: ['Docker', 'GIT', 'Kubernetes', 'Vercel'],
    ...
    {
      title: 'Jeux Vidéos',
      skills: ['Unreal Engine', 'C/C++', 'Fab'],
      color: 'from-orange-500 to-red-500',
    },
    {
      title: 'Business',
      skills: ['Benchmarking', 'Marketing', 'Aquisition de leads', 'Analyse de marché'],
      color: 'from-lime-500 to-green-500',
    },
    {
      title: 'Gestion de projet',
      skills: ['Agile', 'Rédaction', 'Tutoriels', 'Pédagogie'],
